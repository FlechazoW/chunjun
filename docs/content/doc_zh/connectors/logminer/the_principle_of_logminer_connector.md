---
title: ChunJun Oracle LogMiner实时采集基本原理
weight: 4
type: docs
nav-title: ChunJun Oracle LogMiner实时采集基本原理
---
<!--
...
values (HEXTORAW('45465f4748'), HEXTORAW('546563686e6963616c20577269746572'),
...
![image](../../../website/src/images/doc/LogMiner/LogMiner23.png)
...
SELECT MIN(name) name,
       first_change#
FROM (SELECT MIN(member)     AS name,
             first_change#,
...
![image](../../../website/src/images/doc/LogMiner/LogMiner21.png)
